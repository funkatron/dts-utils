...
- **Storage:** History metadata and PNG files live under `web-history` in the dts-util user config directory. `DTS_WEB_HISTORY_DIR` can override the location for tests or operators.
