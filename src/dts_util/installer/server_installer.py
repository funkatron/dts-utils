...
Usage:
    ...
    dts-util \"PROMPT\" [PROFILE] [...]   Shorthand: same as generate with --trust-server-cert --open; PROFILE optional — missing default.json is auto-created (model guessed from Draw Things Models dir) and $DTS_UTIL_DEFAULT_CONFIGURATION is set
